...
import { Building, Search, Plus, Filter, Download, MapPin, Star, Users } from "lucide-react"
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage pilgrim accommodations with AI-powered room assignments and optimization
          </p>
        </div>
        ...
        <CardContent className="pt-6">
          <div className="flex items-center space-x-4">
            <div className="relative flex-1">
              ...
              <Input placeholder="Search accommodations by name, location, or type..." className="pl-10" />
            </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              <span className="text-green-600">+5.3%</span> optimization
            </p>
          </CardContent>
        </Card>
      </div>
